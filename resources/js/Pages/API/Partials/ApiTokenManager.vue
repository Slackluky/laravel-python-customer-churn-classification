...
<template>
    <div>
        <!-- Generate API Token -->
        <JetstreamFormSection @submitted="createApiToken">
            ...
            <template #form>
                ...
                <div v-if="availablePermissions.length > 0" class="col-span-6">
                    <JetstreamLabel for="permissions" value="Permissions" />
        ...
        <div v-if="tokens.length > 0">
            <JetstreamSectionBorder />

            <!-- Manage API Tokens -->
            <div class="mt-10 sm:mt-0">
                <JetstreamActionSection>
        ...
        >
            ...
            <template #footer>
                <JetstreamSecondaryButton @click="displayingToken = false">
                    Close
                </JetstreamSecondaryButton>
            </template>
        </JetstreamDialogModal>
        ...
        >
            ...
            <template #footer>
                <JetstreamSecondaryButton @click="apiTokenBeingDeleted = null">
                    Cancel
                </JetstreamSecondaryButton>
