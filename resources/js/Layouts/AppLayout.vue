...
const dark = computed({
    get() {
        return {
            state: store._state.data.theme.dark,
            value: store._state.data.theme.dark ? darkTheme : null,
        };
    },
});
...
<template>
    <n-config-provider :theme="dark.value">
        <Head :title="title" />
        <!--
            <JetBanner /> -->
        <n-space>
            <n-layout
                has-sider
                position="absolute"
                :class="dark.state ? 'dark' : ''"
            >
                <n-layout-header bordered class="fixed top-0 z-10">
                    <LayoutNavbar @collapse="toggleCollapse" />
                </n-layout-header>
                <n-layout-sider
                    collapse-mode="width"
                    :collapsed-width="60"
                    ...
                    :width="240"
                    :collapsed="collapsed"
                    class="dark:bg-gray-800 border-r-2 border-r-gray-300"
                >
                    <LayoutSidebar :collapsed="collapsed" class="mt-14" />
                </n-layout-sider>
                <n-layout-content :native-scrollbar="false" class="mt-14">
                    <main>
                        <slot />
                    </main>
                </n-layout-content>
